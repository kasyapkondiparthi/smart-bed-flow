  ...
  return (
    <div className="glass-panel p-6 h-full flex flex-col min-h-[350px]">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-sm font-bold text-white tracking-widest uppercase mb-0.5">Clinical Severity</h2>
          <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">Awaiting Triage Distribution</p>
        </div>
      </div>
